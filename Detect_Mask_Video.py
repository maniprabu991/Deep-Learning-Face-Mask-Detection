# -*- coding: utf-8 -*-
"""
Created on Sat Apr 20 19:49:33 2024
...
def detect_and_predict_mask(frame, faceNet, maskNet):
    ...
    for i in range(0, detections.shape[2]):
        ...
        if confidence > 0.5:  # Use confidence directly instead of args
...
mask_model_path = "mask_detectorch.h5"  # Assuming the model file is named correctly
...
maskNet = tf.keras.models.load_model(mask_model_path)
